...
HEADER_COLUMNS = (
    ...
    "day_of_week",
    "hour_of_day",
    "popularity_percent_normal",
    "popularity_percent_current",
)
...
CHROMEDRIVER_BINARY_LOCATION = (
    "/home/leon/programs/SDG/test_google_map/chromedriver/stable/chromedriver"
)
...
SAVE_HTML = "/home/leon/programs/SDG/test_google_map/.cache/html"
...
URL_PATH_INPUT = (
    "/home/leon/programs/SDG/test_google_map/gmaps_popular_times_scraper/test_urls.csv"
)
